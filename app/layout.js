...
export const metadata = {
  ...
  keywords:
    "Full Stack Developer, MERN stack, Next.js, React Native, Flutter, Cross-Platform Development, Portfolio, Atchuta Rama Raju Jampana, jarraju, ajay, ajay2603 Web Development, JavaScript, TypeScript, My Quiz, Pigeon, Safe Sprout, Child Tracking, Mobile App Development",
};
